...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "2. EditExcelReport"
        ...
        Me.Button3.Text = "Option CSV"
        Me.Button3.UseVisualStyleBackColor = True
        '
        'Button4
        '
        Me.Button4.Location = New System.Drawing.Point(93, 226)
        ...
        Me.Label1.Text = "Extract C:\audit-data\*.zip to C:\ExcelIn"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Edit all Excel report in C:\ExcelIn folder"
        '
        'Button5
        '
